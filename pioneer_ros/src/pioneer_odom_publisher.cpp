...
/*void poseCallback(const gazebo_msgs::ModelStates& msg)
{
  ...
  geometry_msgs::Twist current_Twist = msg.twist[2] ;
...
int main(int argc, char **argv)
{
  ...
  pub = nHandle.advertise<nav_msgs::Odometry>("odom", 50) ;
  ros::Subscriber sub = nHandle1.subscribe("/gazebo/model_states", 10, &poseCallback) ;
